<template>
  <div class="max-w-800 w-[800px] mx-auto p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 text-lg py-2">
      ...
      <div>
        <strong class="font-bold text-orange-500">Area:</strong> {{ meal.strArea }}
      </div>
      <div>
        <strong class="font-bold text-orange-500">Tags:</strong> {{ meal.strTags }}
      </div>
    </div>  
    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="mt-4">
        ...
        <a 
          :href="meal.strSource" 
          target="_blank" 
          class="ml-3 px-3 py-2 border-2 boreder-transparent rounded hover:bg-indigo-600 hover:text-white text-indigo-600 transition-colors"
          >
            View Orginal Source
        </a>
      </div>
